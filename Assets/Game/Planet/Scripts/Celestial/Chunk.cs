...
public class Chunk
{
    ...
    public void GenerateChildren()
    {
        ...
        {
            float elevation = TerrainFace.GetElevation(planetScript.shapeConfig, normalizedPos);
    ...
    out Vector3[] newVertices, out int[] newTriangles, out int[] newBorderTriangles, out Vector3[] newBorderVertices, out Vector3[] newNormals, out Vector2[] newUVs, out Color[] newColors)
    {
        ...
        for (int i = 0; i < vertices.Length; i++)
        {
            ...
            float elevation = TerrainFace.GetElevation(planetScript.shapeConfig, pointOnUnitSphere);
